...
public class CompareExcel3 {
	...
	public static void main(String[] args) {
		...
		try {
			FileInputStream f1 = new FileInputStream(".\\resource\\TestBook1.xlsx");
			XSSFWorkbook wb1 = new XSSFWorkbook(f1);
			XSSFSheet sh1 = wb1.getSheetAt(0);
			int rowCount1 = sh1.getPhysicalNumberOfRows();

			FileInputStream f2 = new FileInputStream(".\\resource\\TestBook3.xlsx");
			...
			if (rowCount1 == rowCount2) {
				...
				// write the workbook
				FileOutputStream out = new FileOutputStream(new File(".\\resource\\MissingDataExcel.xlsx"));
				wb3.write(out);
				out.close();
